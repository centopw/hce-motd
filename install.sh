...
MUT='\033[38;5;245m'  # Subtitle Grey
GRN='\033[1;32m'
YLW='\033[1;33m'
RED='\033[1;31m'
NC='\033[0m'
...
# Dynamic Memory Calculation & Bar
...
# Non-root friendly port detection (reads local listening ports directly)
LISTEN_PORTS="$(ss -tuln 2>/dev/null | awk 'NR>1 {print $5}' | sed 's/.*://' | grep -E '^[0-9]+$' | sort -n -u | tr '\n' ' ' | sed 's/ $//')"
